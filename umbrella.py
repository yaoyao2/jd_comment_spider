...
# 词云字体
# WC_FONT_PATH = 'C:/Windows/Fonts/Microsoft YaHei UI.ttc'
# linux字体下载地址：https://linux.linuxidc.com/index.php?folder=cHViLzIwMDkvMTEvMTIvw%20bP8lVidW50dbXEzqLI7dHFutrX1szlVjYuMCBtc3loLnR0ZrG%20tdjPwtTY
# 解压后放在当前目录下
WC_FONT_PATH = 'msyh.ttf'
...
def spider_comment(page=0):
    ...
    ## 雨伞
    url = 'https://sclub.jd.com/comment/productPageComments.action?callback=fetchJSON_comment98vv588&productId=1335950' \
          '&score=0&sortType=5&page=%s&pageSize=10&isShadowSku=0&fold=1' % page
    kv = {'user-agent': 'Mozilla/5.0', 'Referer': 'https://item.jd.com/1335950.html'}
